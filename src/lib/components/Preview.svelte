        ...
        <div class="flex items-center gap-6">
            ...
            <div class="flex-1">
                <h1 class="text-3xl font-black text-black tracking-tight uppercase mb-1">
                    {$cvStore.personalInfo.name || 'Votre Nom'}
                </h1>
                ...
                {#each $cvStore.projects as project}
                    <div>
                        <div class="flex items-baseline gap-2">
                            <h3 class="text-xs font-bold text-black">
                                {project.name}
                            </h3>
                        ...
                        {#if project.description}
                            <div class="mt-1 text-xs font-medium text-neutral-700 leading-relaxed">
                                {project.description}
                            </div>
                        {/if}
                    </div>
